  ...
  return (
    <div className="p-8 h-full flex flex-col items-center justify-center mt-8">
      <div className="max-w-md text-center">
        ...
        {/* Features */}
        <div className="bg-gradient-to-br from-green-900/30 to-emerald-900/30 border border-green-500/20 rounded-xl p-6 mb-8">
        ...
        {/* CTA Button */}
        <button className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 rounded-full text-white font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-green-500/50 hover:shadow-xl">
          Explore Now
        </button>
      </div>
    </div>
